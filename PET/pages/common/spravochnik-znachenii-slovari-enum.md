...
Профильное поле группы видов «Водные и полуводные» (`FISH`, `AXOLOTL`, `FROG`, `TURTLE`) — см. [Профильные поля питомца по видам](../pets/profilnye-polya-pitomtsa-po-vidam.md).
